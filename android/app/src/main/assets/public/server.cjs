var Z=Object.create;var B=Object.defineProperty;var X=Object.getOwnPropertyDescriptor;var $=Object.getOwnPropertyNames;var ee=Object.getPrototypeOf,te=Object.prototype.hasOwnProperty;var ae=(t,e)=>{for(var n in e)B(t,n,{get:e[n],enumerable:!0})},ne=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let a of $(e))!te.call(t,a)&&a!==n&&B(t,a,{get:()=>e[a],enumerable:!(i=X(e,a))||i.enumerable});return t};var k=(t,e,n)=>(n=t!=null?Z(ee(t)):{},ne(e||!t||!t.__esModule?B(n,"default",{value:t,enumerable:!0}):n,t));var M=k(require("express"),1),Y=k(require("cors"),1),I=k(require("path"),1),A=k(require("fs"),1),K=require("vite");var F=require("drizzle-orm/better-sqlite3"),G=k(require("better-sqlite3"),1);var q={};ae(q,{articleTopics:()=>C,ayahReferences:()=>T,ayahScienceRelationships:()=>v,discussions:()=>b,scienceArticles:()=>g,scienceTopics:()=>x,tafseerReferences:()=>Q});var s=require("drizzle-orm/sqlite-core"),H=require("drizzle-orm"),b=(0,s.sqliteTable)("discussions",{id:(0,s.text)("id").primaryKey(),content:(0,s.text)("content").notNull(),author:(0,s.text)("author").notNull().default("Anonymous"),email:(0,s.text)("email"),createdAt:(0,s.text)("created_at").notNull().default(H.sql`CURRENT_TIMESTAMP`),replyToId:(0,s.text)("reply_to_id"),isModerated:(0,s.integer)("is_moderated",{mode:"boolean"}).notNull().default(!1)}),T=(0,s.sqliteTable)("ayah_references",{id:(0,s.text)("id").primaryKey(),discussionId:(0,s.text)("discussion_id").notNull().references(()=>b.id),surahNumber:(0,s.integer)("surah_number").notNull(),ayahNumber:(0,s.integer)("ayah_number").notNull(),surahName:(0,s.text)("surah_name")}),Q=(0,s.sqliteTable)("tafseer_references",{id:(0,s.text)("id").primaryKey(),discussionId:(0,s.text)("discussion_id").notNull().references(()=>b.id),surahNumber:(0,s.integer)("surah_number").notNull(),ayahNumber:(0,s.integer)("ayah_number").notNull(),language:(0,s.text)("language").notNull(),source:(0,s.text)("source").notNull()}),g=(0,s.sqliteTable)("science_articles",{id:(0,s.text)("id").primaryKey(),title:(0,s.text)("title").notNull(),author:(0,s.text)("author"),content:(0,s.text)("content").notNull(),source:(0,s.text)("source").notNull(),originalUrl:(0,s.text)("original_url"),license:(0,s.text)("license"),publicationDate:(0,s.text)("publication_date"),createdAt:(0,s.text)("created_at").notNull().default(H.sql`CURRENT_TIMESTAMP`)}),x=(0,s.sqliteTable)("science_topics",{id:(0,s.text)("id").primaryKey(),name:(0,s.text)("name").notNull().unique()}),C=(0,s.sqliteTable)("article_topics",{id:(0,s.text)("id").primaryKey(),articleId:(0,s.text)("article_id").notNull().references(()=>g.id),topicId:(0,s.text)("topic_id").notNull().references(()=>x.id)}),v=(0,s.sqliteTable)("ayah_science_relationships",{id:(0,s.text)("id").primaryKey(),surahNumber:(0,s.integer)("surah_number").notNull(),ayahNumber:(0,s.integer)("ayah_number").notNull(),articleId:(0,s.text)("article_id").notNull().references(()=>g.id),explanation:(0,s.text)("explanation"),createdAt:(0,s.text)("created_at").notNull().default(H.sql`CURRENT_TIMESTAMP`)});var O=k(require("path"),1),J=k(require("os"),1),ie=process.env.K_SERVICE!==void 0||process.env.NODE_ENV==="production",oe=ie?J.default.tmpdir():process.cwd(),se=O.default.join(oe,"quran.db"),D=new G.default(se);D.exec(`
...
`);var m=(0,F.drizzle)(D,{schema:q});var f=require("drizzle-orm"),E=require("uuid");var L=require("@google/genai"),S=k(require("fs"),1),N=k(require("path"),1);function P(t){if(!t||typeof t!="string")return"";let e=t;e=e.replace(/لد\s*دکم\s*2ے\s*ات\s*کک\s*و\s*لن\s*[۰-۹0-9]+/g,""),e=e.replace(/ہن\s*[۰-۹0-9]+\s*لج\s*کس\s*رض\s*جلردام/g,""),e=e.replace(/رازوا\s*[۰-۹0-9]+\s*لے\s*اد\s*جلد\s*دگم/g,""),e=e.replace(/لددم\s*\(لجھر\s*یکس\s*ریب\s*دنن\s*[۰-۹0-9]+/g,""),e=e.replace(/[0-9۰-۹]+\s*ال\s*ےن\s*ستچاضہ\s*این\s*[۰-۹0-9]+ہ?/g,""),e=e.replace(/زی\s*\.?[0-9۰-۹]*ک\s*یر\s*کی\s*ات\s*تد\s*کس\s*نی\s*جہ/g,""),e=e.replace(/پواللوالزخمن\s*الرْحْٔمو\s*ہنام\s*خدائۓ\s*رن\s*ریم\s*یج/g,"\u0628\u0650\u0633\u0652\u0645\u0650 \u0627\u0644\u0644\u064E\u0651\u0647\u0650 \u0627\u0644\u0631\u064E\u0651\u062D\u0652\u0645\u064E\u0670\u0646\u0650 \u0627\u0644\u0631\u064E\u0651\u062D\u0650\u064A\u0645\u0650 \u2014 \u0628\u0646\u0627\u0645 \u062E\u062F\u0627\u0626\u06D2 \u0631\u062D\u0645\u0646 \u0648 \u0631\u062D\u06CC\u0645"),e=e.replace(/(^|\s)0+[0-9۰-۹]+(\s|$)/g," "),e=e.replace(/(^|\s)[0-9]{3,7}(\s|$)/g," "),e=e.replace(/\b0\s+0\s+0*\b/g," "),e=e.replace(/\b02\b/g," "),e=e.replace(/\b08\b/g," "),e=e.replace(/\b77۴\b/g," "),e=e.replace(/\b۹ھ\b/g," "),e=e.replace(/\b008\b/g," "),e=e.replace(/\b000٦‏\b/g," "),e=e.replace(/\b۔ٌ٤ےس\b/g," "),e=e.replace(/\b٤‏\b/g," "),e=e.replace(/[\^~|_]/g," "),e=e.replace(/\(۷×\s*×ظ/g,""),e=e.replace(/۷۸\s*:ا\s*طط/g,""),e=e.replace(/1\s*کارل/g,"\u06A9\u0627\u0631\u0644"),e=e.replace(/صلی\s*ال\s*علیہ\s*دالہ\s*یلم/g,"(\u0635\u0644\u06CC \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1 \u0648 \u0622\u0644\u06C1 \u0648\u0633\u0644\u0645)"),e=e.replace(/رسول\s*ال\s*مل\s*پا/g,"\u0631\u0633\u0648\u0644 \u0627\u0644\u0644\u06C1 (\u0635\u0644\u06CC \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1 \u0648 \u0622\u0644\u06C1 \u0648\u0633\u0644\u0645)"),e=e.replace(/رعول\s*الد\s*مک/g,"\u0631\u0633\u0648\u0644 \u0627\u0644\u0644\u06C1 (\u0635\u0644\u06CC \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1 \u0648 \u0622\u0644\u06C1 \u0648\u0633\u0644\u0645)"),e=e.replace(/رسول\s*ال\s*مک/g,"\u0631\u0633\u0648\u0644 \u0627\u0644\u0644\u06C1 (\u0635\u0644\u06CC \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1 \u0648 \u0622\u0644\u06C1 \u0648\u0633\u0644\u0645)"),e=e.replace(/رسول\s*اللہ\s*مک/g,"\u0631\u0633\u0648\u0644 \u0627\u0644\u0644\u06C1 (\u0635\u0644\u06CC \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1 \u0648 \u0622\u0644\u06C1 \u0648\u0633\u0644\u0645)"),e=e.replace(/تضور\s*اگرم\s*\(ص\)/g,"\u062D\u0636\u0648\u0631 \u0627\u06A9\u0631\u0645 (\u0635\u0644\u06CC \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1 \u0648 \u0622\u0644\u06C1 \u0648\u0633\u0644\u0645)"),e=e.replace(/تضور\s*\(ص\)/g,"\u062D\u0636\u0648\u0631 (\u0635\u0644\u06CC \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1 \u0648 \u0622\u0644\u06C1 \u0648\u0633\u0644\u0645)"),e=e.replace(/سلام\s*اللعہما/g,"\u0633\u0644\u0627\u0645 \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1\u0627"),e=e.replace(/سلام\s*انل\s*ہا/g,"\u0633\u0644\u0627\u0645 \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1\u0627"),e=e.replace(/سلام\s*الڈعہا/g,"\u0633\u0644\u0627\u0645 \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1\u0627"),e=e.replace(/سلام\s*اللہ\s*علیھا/g,"\u0633\u0644\u0627\u0645 \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1\u0627"),e=e.replace(/علیھم\s*السلام/g,"\u0639\u0644\u06CC\u06C1\u0645 \u0627\u0644\u0633\u0644\u0627\u0645"),e=e.replace(/ذا\s*گرا\s*ٹی/g,"\u0630\u0627\u062A\u0650 \u06AF\u0631\u0627\u0645\u06CC"),e=e.replace(/دالکن\s*اسلام/g,"\u062F\u0627\u0645\u0646\u0650 \u0627\u0633\u0644\u0627\u0645"),e=e.replace(/اولاد\s*ہر\s*اءسلام\s*الڈعہا\s*کے\s*مم\s*رمونع\s*مشت/g,"\u0627\u0648\u0644\u0627\u062F\u0650 \u0632\u06C1\u0631\u0627\u0621 \u0633\u0644\u0627\u0645 \u0627\u0644\u0644\u06C1 \u0639\u0644\u06CC\u06C1\u0627 \u06A9\u06D2 \u0645\u0631\u06C1\u0648\u0646\u0650 \u0645\u0646\u062A"),e=e.replace(/حلضرت\s*اکم\s*کانانال\s*ہوا/g,"\u062D\u0636\u0631\u062A \u0642\u0627\u0633\u0645 \u06A9\u0627 \u0627\u0646\u062A\u0642\u0627\u0644 \u06C1\u0648\u0627"),e=e.replace(/حضرت\s*عبر\s*الد\s*اف\s*اتال\s*ہوگیا/g,"\u062D\u0636\u0631\u062A \u0639\u0628\u062F \u0627\u0644\u0644\u06C1 \u06A9\u0627 \u0627\u0646\u062A\u0642\u0627\u0644 \u06C1\u0648 \u06AF\u06CC\u0627"),e=e.replace(/صاحپ\s*تفھیم\s*النمرآن/g,"\u0635\u0627\u062D\u0628 \u062A\u0641\u06C1\u06CC\u0645 \u0627\u0644\u0642\u0631\u0622\u0646"),e=e.replace(/فخر\s*الددین\s*رازی\s*اپ\s*فی\s*میں\s*ککھنے\s*ہیں/g,"\u0641\u062E\u0631 \u0627\u0644\u062F\u06CC\u0646 \u0631\u0627\u0632\u06CC \u0627\u067E\u0646\u06CC \u062A\u0641\u0633\u06CC\u0631 \u0645\u06CC\u06BA \u0644\u06A9\u06BE\u062A\u06D2 \u06C1\u06CC\u06BA"),e=e.replace(/صاحب\s*تیر\s*روح\s*المعانی/g,"\u0635\u0627\u062D\u0628 \u062A\u0641\u0633\u06CC\u0631 \u0631\u0648\u062D \u0627\u0644\u0645\u0639\u0627\u0646\u06CC");let n=[[/\bک\s+ر\s+ن\s+ا\b/g,"\u06A9\u0631\u0646\u0627"],[/\bک\s+ر\s+ن\s+ے\b/g,"\u06A9\u0631\u0646\u06D2"],[/\bک\s+ر\s+ت\s+ا\b/g,"\u06A9\u0631\u062A\u0627"],[/\bک\s+ر\s+ت\s+ی\b/g,"\u06A9\u0631\u062A\u06CC"],[/\bک\s+ر\s+ت\s+ے\b/g,"\u06A9\u0631\u062A\u06D2"],[/\bک\s+ر\s+د\s+ی\b/g,"\u06A9\u0631 \u062F\u06CC"],[/\bک\s+ر\s+د\s+ی\s+ا\b/g,"\u06A9\u0631 \u062F\u06CC\u0627"],[/\bہ\s+و\s+ت\s+ا\b/g,"\u06C1\u0648\u062A\u0627"],[/\bہ\s+و\s+ت\s+ی\b/g,"\u06C1\u0648\u062A\u06CC"],[/\bہ\s+و\s+ت\s+ے\b/g,"\u06C1\u0648\u062A\u06D2"],[/\bہ\s+و\s+ن\s+ا\b/g,"\u06C1\u0648\u0646\u0627"],[/\bہ\s+و\s+ں\b/g,"\u06C1\u0648\u06BA"],[/\bہ\s+ی\s+ں\b/g,"\u06C1\u06CC\u06BA"],[/\bت\s+ھ\s+ا\b/g,"\u062A\u06BE\u0627"],[/\bت\s+ھ\s+ی\b/g,"\u062A\u06BE\u06CC"],[/\bت\s+ھ\s+ے\b/g,"\u062A\u06BE\u06D2"],[/\bم\s+ی\s+ں\b/g,"\u0645\u06CC\u06BA"],[/\bس\s+ے\b/g,"\u0633\u06D2"],[/\bک\s+ے\b/g,"\u06A9\u06D2"],[/\bک\s+ی\b/g,"\u06A9\u06CC"],[/\bک\s+ا\b/g,"\u06A9\u0627"],[/\bک\s+و\b/g,"\u06A9\u0648"],[/\bپ\s+ر\b/g,"\u067E\u0631"],[/\bا\s+و\s+ر\b/g,"\u0627\u0648\u0631"],[/\bا\s+ی\s+ک\b/g,"\u0627\u06CC\u06A9"],[/\bا\s+س\b/g,"\u0627\u0633"],[/\bا\s+ن\b/g,"\u0627\u0646"],[/\bج\s+ا\s+ت\s+ا\b/g,"\u062C\u0627\u062A\u0627"],[/\bج\s+ا\s+ت\s+ی\b/g,"\u062C\u0627\u062A\u06CC"],[/\bج\s+ا\s+ت\s+ے\b/g,"\u062C\u0627\u062A\u06D2"],[/\bہ\s+ے\b/g,"\u06C1\u06D2"],[/\bن\s+ہ\s+ی\s+ں\b/g,"\u0646\u06C1\u06CC\u06BA"],[/\bت\s+و\b/g,"\u062A\u0648"],[/\bج\s+و\b/g,"\u062C\u0648"],[/\bد\s+ی\s+ا\b/g,"\u062F\u06CC\u0627"],[/\bگ\s+ی\s+ا\b/g,"\u06AF\u06CC\u0627"],[/\bگ\s+ئ\s+ے\b/g,"\u06AF\u0626\u06D2"],[/\bل\s+ی\s+ے\b/g,"\u0644\u06CC\u06D2"],[/\bک\s+ہ\b/g,"\u06A9\u06C1"],[/\bب\s+ھ\s+ی\b/g,"\u0628\u06BE\u06CC"],[/\bب\s+ا\s+ت\b/g,"\u0628\u0627\u062A"],[/\bپ\s+ہ\s+ل\s+ے\b/g,"\u067E\u06C1\u0644\u06D2"],[/\bب\s+ع\s+د\b/g,"\u0628\u0639\u062F"],[/\bس\s+ا\s+ت\s+ھ\b/g,"\u0633\u0627\u062A\u06BE"],[/\bط\s+ر\s+ح\b/g,"\u0637\u0631\u062D"],[/\bق\s+ر\s+آ\s+ن\b/g,"\u0642\u0631\u0622\u0646"],[/\bر\s+س\s+و\s+ل\b/g,"\u0631\u0633\u0648\u0644"],[/\bا\s+ل\s+ل\s+ہ\b/g,"\u0627\u0644\u0644\u06C1"],[/\bن\s+ا\s+ز\s+ل\b/g,"\u0646\u0627\u0632\u0644"],[/\bآ\s+ی\s+ت\b/g,"\u0622\u06CC\u062A"],[/\bس\s+و\s+ر\s+ۃ\b/g,"\u0633\u0648\u0631\u06C3"],[/\bس\s+و\s+ر\s+ہ\b/g,"\u0633\u0648\u0631\u06C1"],[/\bت\s+ف\s+س\s+ی\s+ر\b/g,"\u062A\u0641\u0633\u06CC\u0631"],[/\bم\s+ط\s+ل\s+ب\b/g,"\u0645\u0637\u0644\u0628"],[/\bم\s+ع\s+ن\s+ی\b/g,"\u0645\u0639\u0646\u06CC"],[/\bد\s+ل\s+ی\s+ل\b/g,"\u062F\u0644\u06CC\u0644"],[/\bح\s+ق\s+ی\s+ق\s+ت\b/g,"\u062D\u0642\u06CC\u0642\u062A"],[/\bا\s+ن\s+س\s+ا\s+ن\b/g,"\u0627\u0646\u0633\u0627\u0646"],[/\bح\s+ض\s+ر\s+ت\b/g,"\u062D\u0636\u0631\u062A"],[/\bا\s+م\s+ا\s+م\b/g,"\u0627\u0645\u0627\u0645"],[/\bع\s+ل\s+ی\b/g,"\u0639\u0644\u06CC"],[/\bص\s+ا\s+د\s+ق\b/g,"\u0635\u0627\u062F\u0642"],[/\bب\s+ا\s+ق\s+ر\b/g,"\u0628\u0627\u0642\u0631"],[/\bر\s+ض\s+ا\b/g,"\u0631\u0636\u0627"],[/\bک\s+ا\s+ظ\s+م\b/g,"\u06A9\u0627\u0638\u0645"],[/\bح\s+س\s+ن\b/g,"\u062D\u0633\u0646"],[/\bح\s+س\s+ی\s+ن\b/g,"\u062D\u0633\u06CC\u0646"],[/\bف\s+ا\s+ط\s+م\s+ہ\b/g,"\u0641\u0627\u0637\u0645\u06C1"],[/\bپ\s+ی\s+غ\s+م\s+ب\s+ر\b/g,"\u067E\u06CC\u063A\u0645\u0628\u0631"],[/\bن\s+ب\s+ی\b/g,"\u0646\u0628\u06CC"],[/\bو\s+ح\s+ی\b/g,"\u0648\u062D\u06CC"],[/\bف\s+ر\s+ش\s+ت\s+ہ\b/g,"\u0641\u0631\u0634\u062A\u06C1"],[/\bج\s+ب\s+ر\s+ا\s+ئ\s+ی\s+ل\b/g,"\u062C\u0628\u0631\u0627\u0626\u06CC\u0644"],[/\bا\s+ن\s+ب\s+ی\s+ا\s+ء\b/g,"\u0627\u0646\u0628\u06CC\u0627\u0621"],[/\bد\s+و\s+س\s+ر\s+ی\b/g,"\u062F\u0648\u0633\u0631\u06CC"],[/\bپ\s+ہ\s+ل\s+ی\b/g,"\u067E\u06C1\u0644\u06CC"],[/\bت\s+ی\s+س\s+ر\s+ی\b/g,"\u062A\u06CC\u0633\u0631\u06CC"],[/\bج\s+ی\s+س\s+ے\b/g,"\u062C\u06CC\u0633\u06D2"],[/\bل\s+و\s+گ\b/g,"\u0644\u0648\u06AF"],[/\bن\s+ا\s+م\b/g,"\u0646\u0627\u0645"],[/\bد\s+ل\b/g,"\u062F\u0644"],[/\bر\s+ا\s+ہ\b/g,"\u0631\u0627\u06C1"],[/\bع\s+ق\s+ل\b/g,"\u0639\u0642\u0644"],[/\bج\s+ا\s+ن\b/g,"\u062C\u0627\u0646"],[/\bج\s+س\b/g,"\u062C\u0633"],[/\bج\s+ن\b/g,"\u062C\u0646"],[/\bت\s+ب\b/g,"\u062A\u0628"],[/\bج\s+ب\b/g,"\u062C\u0628"],[/\bس\s+ب\b/g,"\u0633\u0628"]];for(let[i,a]of n)e=e.replace(i,a);return e=e.replace(/([\u0600-\u06FF])\s+([\u0600-\u06FF])\s+([\u0600-\u06FF])\s+([\u0600-\u06FF])/g,"$1$2$3$4"),e=e.replace(/([\u0600-\u06FF])\s+([\u0600-\u06FF])\s+([\u0600-\u06FF])/g,"$1$2$3"),e=e.replace(/[ \t]+/g," "),e=e.replace(/\n\s*\n\s*\n+/g,`

`),e=e.replace(/([۔،])\s*([۔،])/g,"$1"),e.trim()}var R=null;function re(){if(!R){let t=process.env.GEMINI_API_KEY;t&&(R=new L.GoogleGenAI({apiKey:t}))}return R}var j=N.default.join(process.cwd(),"public","tafseer_kauthar_refined");if(!S.default.existsSync(j))try{S.default.mkdirSync(j,{recursive:!0})}catch(t){console.error("Could not create refined dir:",t)}async function U(t,e,n,i=!1){let a=N.default.join(j,`s${t}_a${e}.json`);if(!i&&S.default.existsSync(a))try{let r=JSON.parse(S.default.readFileSync(a,"utf8"));if(r&&r.text&&r.text.trim().length>0)return{text:r.text,isAiRefined:!0}}catch{}let o=P(n||"");if(!o||o.trim().length<20)return{text:o||"",isAiRefined:!1};let l=re();if(!l)return{text:o,isAiRefined:!1};let u=`You are a world-class Islamic scholar and master Urdu proofreader specializing in "Tafseer Al-Kauthar" (\u062A\u0641\u0633\u06CC\u0631 \u0627\u0644\u06A9\u0648\u062B\u0631) by Allama Sheikh Mohsin Ali Najafi (\u0639\u0644\u0627\u0645\u06C1 \u0634\u06CC\u062E \u0645\u062D\u0633\u0646 \u0639\u0644\u06CC \u0646\u062C\u0641\u06CC).
...
5. Return ONLY the corrected Urdu commentary text without conversational filler, preambles, or English explanations.`,y=`Please proofread, correct vocabulary, repair broken ligatures/words, and fix all grammatical errors for Surah ${t}, Ayah ${e} of Tafseer Al-Kauthar:

---
${o.slice(0,15e3)}
---`,c=["gemini-3.1-flash-lite","gemini-3.6-flash","gemini-3.8-flash"];for(let r of c)try{let d=(await l.models.generateContent({model:r,contents:y,config:{systemInstruction:u,temperature:.2}})).text?.trim();if(d&&d.length>30){try{S.default.writeFileSync(a,JSON.stringify({surah:t,ayah:e,text:d,refinedAt:new Date().toISOString(),model:r},null,2),"utf8")}catch(w){console.error("Error saving refined cache:",w)}return{text:d,isAiRefined:!0}}}catch(h){h?.status==="RESOURCE_EXHAUSTED"||h?.message?.includes("429")||h?.message?.includes("Quota exceeded")?console.warn(`Gemini quota limit reached on ${r} for Surah ${t} Ayah ${e}. Attempting fallback or graceful return.`):console.warn(`Gemini approximation note for Surah ${t} Ayah ${e} on ${r}:`,h?.message||h)}return{text:o,isAiRefined:!1,quotaExceeded:!0}}var z={articles:[{id:"21a6264f-39cb-4ce2-9983-aeea1989426d",title:"Human",author:"Quran & Science",content:`Has anyone ever thought, before the Quran was revealed, that man\u2019s nutfa, when ejected, is responsible for determining if the embryo will be male or female? Has this ever occurred to one\u2019s mind? The Quran says;
...
\u201CA Muslim is a person whose tongue and hand is safeguarded against, and an emigrant is a person who has left that which Allah prohibited!.\u201D (Agreed upon)`,source:"Quran and Science",original_url:"https://quranandscience.com/embracing-islam/fakes-about-islam/263-islam-is-the-faith-of-peace/",license:"Fair Use / Permitted Metadata",publication_date:"2010-05-03T16:34:11",created_at:"2026-08-23 09:55:30"}]};var p=z;async function _(){if(console.log("Starting to seed database from data.json..."),p.topics&&p.topics.length>0&&await m.insert(x).values(p.topics).execute(),p.articles&&p.articles.length>0){let t=p.articles.map(n=>({id:n.id,title:n.title,author:n.author,content:n.content,source:n.source,originalUrl:n.original_url,license:n.license,publicationDate:n.publication_date,createdAt:n.created_at})),e=50;for(let n=0;n<t.length;n+=e){let i=t.slice(n,n+e);await m.insert(g).values(i).execute()}}if(p.articleTopics&&p.articleTopics.length>0){let t=p.articleTopics.map(n=>({id:n.id,articleId:n.article_id,topicId:n.topic_id})),e=50;for(let n=0;n<t.length;n+=e){let i=t.slice(n,n+e);await m.insert(C).values(i).execute()}}if(p.relationships&&p.relationships.length>0){let t=p.relationships.map(n=>({id:n.id,surahNumber:n.surah_number,ayahNumber:n.ayah_number,articleId:n.article_id,explanation:n.explanation,createdAt:n.created_at})),e=50;for(let n=0;n<t.length;n+=e){let i=t.slice(n,n+e);await m.insert(v).values(i).execute()}}console.log("Seeding complete. Seeded "+p.articles.length+" articles.")}async function le(){let t=(0,M.default)(),e=3e3;if(t.use((0,Y.default)()),t.use(M.default.json({limit:"50mb"})),t.use(M.default.urlencoded({limit:"50mb",extended:!0})),t.use((i,a,o,l)=>{if(i?.type==="entity.too.large"||i?.status===413)return console.warn("PayloadTooLarge caught in middleware:",i.message),o.status(413).json({error:"Payload too large. Please send smaller data."});if(i instanceof SyntaxError&&"body"in i)return o.status(400).json({error:"Invalid JSON format"});l(i)}),t.get("/api/health",(i,a)=>{a.json({status:"ok"})}),t.get("/privacy",(i,a)=>{a.setHeader("Content-Type","text/html; charset=utf-8"),a.send(`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`)}),t.get("/terms",(i,a)=>{a.setHeader("Content-Type","text/html; charset=utf-8"),a.send(`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`)}),t.get("/data-deletion",(i,a)=>{a.setHeader("Content-Type","text/html; charset=utf-8"),a.send(`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`)}),t.get("/.well-known/assetlinks.json",(i,a)=>{a.setHeader("Content-Type","application/json"),a.json([{relation:["delegate_permission/common.handle_all_urls"],target:{namespace:"android_app",package_name:"com.tafseerenamoona.app",sha256_cert_fingerprints:["14:6D:E9:75:A8:6A:B2:D6:70:E7:0F:7B:8A:2C:9E:54:19:BE:84:89:FA:17:F1:C9:F6:41:61:A9:72:A2:3E:04"]}}])}),(async()=>{try{(await m.select().from(g).limit(1).execute()).length===0&&(console.log("Database empty. Seeding in background..."),await _(),console.log("Database seeding completed."))}catch(i){console.error("Failed to seed database:",i)}})(),t.get("/api/tafseer/proxy/:id",async(i,a)=>{try{let o=i.params.id,l=await fetch(`https://www.tafseerenamoona.net/surahs/${o}`);if(!l.ok)return a.status(l.status).json({error:"Failed to fetch from tafseerenamoona.net"});let u=await l.text();a.send(u)}catch(o){console.error(o),a.status(500).json({error:o.message})}}),t.get("/api/tafseer/kauthar/:surah/:ayah",async(i,a)=>{try{let o=parseInt(i.params.surah,10),l=parseInt(i.params.ayah,10),u=i.query.autoRefine==="true"||i.query.refine==="true",y=I.default.join(process.cwd(),"public","tafseer_kauthar_refined",`s${o}_a${l}.json`);if(A.default.existsSync(y))try{let h=JSON.parse(A.default.readFileSync(y,"utf8"));if(h&&h.text)return a.json({surah:o,ayah:l,ur:h.text,en:"Tafseer Al-Kauthar by Allama Sheikh Mohsin Ali Najafi",tafseer_title:"\u062A\u0641\u0633\u06CC\u0631 \u0627\u0644\u06A9\u0648\u062B\u0631 \u2014 \u0639\u0644\u0627\u0645\u06C1 \u0634\u06CC\u062E \u0645\u062D\u0633\u0646 \u0639\u0644\u06CC \u0646\u062C\u0641\u06CC"})}catch{}let c=I.default.join(process.cwd(),"public","tafseer_kauthar",`surah_${o}.json`),r=null;if(A.default.existsSync(c)){let h=A.default.readFileSync(c,"utf8");r=JSON.parse(h).find(w=>w.ayah===l)}if(r){let h=P(r.ur||"");return a.json({...r,ur:h,en:"Tafseer Al-Kauthar by Allama Sheikh Mohsin Ali Najafi",tafseer_title:"\u062A\u0641\u0633\u06CC\u0631 \u0627\u0644\u06A9\u0648\u062B\u0631 \u2014 \u0639\u0644\u0627\u0645\u06C1 \u0634\u06CC\u062E \u0645\u062D\u0633\u0646 \u0639\u0644\u06CC \u0646\u062C\u0641\u06CC"})}a.status(404).json({error:`Tafseer Al-Kauthar not found for Surah ${o}, Ayah ${l}`})}catch(o){a.status(500).json({error:o.message})}}),t.post("/api/tafseer/kauthar/refine",async(i,a)=>{try{let{surah:o,ayah:l,rawText:u,force:y}=i.body,c=parseInt(o,10),r=parseInt(l,10),h=u;if(!h){let w=I.default.join(process.cwd(),"public","tafseer_kauthar",`surah_${c}.json`);if(A.default.existsSync(w)){let W=JSON.parse(A.default.readFileSync(w,"utf8")).find(V=>V.ayah===r);W&&(h=W.ur)}}if(!h)return a.status(404).json({error:"Text to refine not found."});let d=await U(c,r,h,y===!0);return a.json({surah:c,ayah:r,ur:d.text,isAiRefined:d.isAiRefined})}catch(o){a.status(500).json({error:o.message})}}),t.get("/api/tafseer/kauthar/:surah",async(i,a)=>{try{let o=parseInt(i.params.surah,10),l=I.default.join(process.cwd(),"public","tafseer_kauthar",`surah_${o}.json`);if(A.default.existsSync(l)){let u=A.default.readFileSync(l,"utf8");return a.json(JSON.parse(u))}a.status(404).json({error:`Tafseer Al-Kauthar not found for Surah ${o}`})}catch(o){a.status(500).json({error:o.message})}}),t.get("/api/discussions",async(i,a)=>{try{let{surah:o,ayah:l}=i.query,u=m.select({discussion:b,ayahRef:T}).from(b).leftJoin(T,(0,f.eq)(b.id,T.discussionId));if(o&&l){let c=parseInt(o),r=parseInt(l),h=await u.where((0,f.and)((0,f.eq)(T.surahNumber,c),(0,f.eq)(T.ayahNumber,r))).orderBy((0,f.desc)(b.createdAt)).execute();return a.json(h)}let y=await u.orderBy((0,f.desc)(b.createdAt)).limit(50).execute();a.json(y)}catch(o){a.status(500).json({error:o.message})}}),t.post("/api/discussions",async(i,a)=>{try{let{content:o,author:l,email:u,replyToId:y,surahNumber:c,ayahNumber:r,surahName:h,tafseerRef:d}=i.body;if(!o||o.trim().length===0)return a.status(400).json({error:"Content is required"});let w=(0,E.v4)();await m.insert(b).values({id:w,content:o.trim(),author:l?.trim()||"Anonymous",email:u?.trim()||null,replyToId:y||null,isModerated:!1}).execute(),c&&r&&await m.insert(T).values({id:(0,E.v4)(),discussionId:w,surahNumber:c,ayahNumber:r,surahName:h||""}).execute(),d&&await m.insert(Q).values({id:(0,E.v4)(),discussionId:w,surahNumber:d.surahNumber||c,ayahNumber:d.ayahNumber||r,language:d.language,source:d.source}).execute(),a.json({success:!0,id:w})}catch(o){a.status(500).json({error:o.message})}}),t.get("/api/science",async(i,a)=>{try{let{surah:o,ayah:l}=i.query;if(o){let r=parseInt(o),h=[(0,f.eq)(v.surahNumber,r)];l&&h.push((0,f.eq)(v.ayahNumber,parseInt(l)));let d=await m.select({article:g,relation:v}).from(v).innerJoin(g,(0,f.eq)(v.articleId,g.id)).where((0,f.and)(...h)).execute();return a.json(d)}let u=await m.select().from(g).orderBy((0,f.desc)(g.createdAt)).execute(),y=await m.select().from(v).execute(),c=u.map(r=>({...r,relations:y.filter(h=>h.articleId===r.id)}));a.json(c)}catch(o){a.status(500).json({error:o.message})}}),process.env.NODE_ENV==="production"||process.argv[1]?.endsWith("server.cjs")){let i=I.default.join(process.cwd(),"dist");t.use(M.default.static(i)),t.get("*",(a,o)=>{o.sendFile(I.default.join(i,"index.html"))})}else{let i=await(0,K.createServer)({server:{middlewareMode:!0},appType:"spa"});t.use(i.middlewares)}t.listen(e,"0.0.0.0",()=>{console.log(`Server running on http://localhost:${e}`)})}le();
